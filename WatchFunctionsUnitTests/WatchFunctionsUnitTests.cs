...
namespace WatchFunctionsUnitTests
{
    public class WatchFunctionsUnitTests
    {
        ...
        public void TestWatchFunctionSuccess()
        {
            ...
            var watchInfoString = $"Watch Details: {watchinfo.Manufacturer}, {watchinfo.CaseType}, {watchinfo.Bezel}, {watchinfo.Dial}, {watchinfo.CaseFinish}, {watchinfo.Jewels}";
            Assert.Equal(watchInfoString, result.Value);
        }
